...
import ru.l0rryq.hud.config.hud.other.PlayerCountSettings;
...
public class PlayerCountHUD extends AbstractHUD  {
    ...
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("lryq-hud", "hud/player_count.png");
