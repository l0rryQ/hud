...
public class ReachSettings {
    ...
    public BaseHUDSettings base = new BaseHUDSettings(false, 0, -171, ScreenAlignmentX.CENTER, ScreenAlignmentY.BOTTOM, GrowthDirectionX.CENTER, GrowthDirectionY.UP);
